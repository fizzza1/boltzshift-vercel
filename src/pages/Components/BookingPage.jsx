...
function BookingPage() {
  ...
  return (
    <div className="grid grid-cols-1 text-center tracking-wider pt-10">
      <h2 className="yolk">Book a free 25 mins appointment with us</h2>
      ...
      <div className="grid grid-cols-2   mt-8 h-[60vh]">
        {/* Left side content */}
        <div className="h-[60vh]  bg-[#07070A] p-4 flex flex-col  items-start">
          <img src={Banner2} />
        </div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(72, 61, 9) 34%, #07070A 70%)",
            backgroundSize: "cover", // Ensures the gradient fills the entire div
          }}
        >
          {
            level == 0 ? 
            ...
            <h2 className="text-xl text-start font-semibold mb-5 black " onClick={()=>setLevel(level-1)}><BsArrow90DegLeft/></h2>
              <div>
              ...
              <div>
                <label className="block black text-start text-sm font-medium text-gray-700">Email *</label>
                <input
                  type="email"
        ...
        {
          level == 0 &&
          <div className="w-[90%] flex justify-end pb-10">
            <button onClick={()=>(setLevel(level+1))} className="bg-yellow-500  text-black font-semibold py-2 px-6 rounded-lg hover:bg-yellow-400 w-30 transition-all duration-300">
              Submit
            </button>
          </div> 
        }
